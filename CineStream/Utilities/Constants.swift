...
struct Constants {
    ...
    static let trendingMovingString = "Trending Movies"
    static let tredingTVString = "Trending TV"
    static let topRateMovieString = "Top Rated Movies"
    static let topRateTVString = "Top Rated TV"
